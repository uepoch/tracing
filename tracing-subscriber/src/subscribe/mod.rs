...
//!     <code>Collect</code> capable of supporting <code>Layer</code>s with
    ...
    Self: 'static,
{
    ...
    /// that the inner `Subscribe`s' `on_subscribe` methods are called. Otherwise,
