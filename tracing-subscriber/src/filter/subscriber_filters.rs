...
/// [documentation on per-subscriber filtering][plf] for details.
///
/// [`Filter`]: crate::subscribe::Filter
...
///
/// See the [documentation on per-subscriber filtering][plf] for details.
///
...
/// `MagicPlfDowncastMarker`. Since subscribers which contain other subscribers permit
